...
import { Wallet, Zap, ShoppingCart, LogOut, Store, GraduationCap, Sparkles } from 'lucide-react'
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans relative overflow-x-hidden selection:bg-indigo-500 selection:text-white">
      {/* Luces de Fondo (Background Glow) */}
          ...
          <div className="flex items-center gap-3">
            ...
            {user ? (
              ...
              <button 
                ...
                className="bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-500 hover:to-violet-500 text-white text-xs font-bold px-4 py-2.5 rounded-2xl transition duration-200 shadow-lg shadow-indigo-600/25 flex items-center gap-1.5"
              >
                <Sparkles className="w-3.5 h-3.5" /> Iniciar Sesión
              </button>
            )}
          </div>
        </div>
